from src.probability import normal_cdf, inverse_normal_cdf
...
assert f"{two_sided_p_value(z):.3f}" == "0.254"

z = a_b_test_statistic(1000, 200, 1000, 150)
assert f"{two_sided_p_value(z):.3f}" == "0.003"


def main():
    # Let's say that we choose to flip the coin n = 1000 times.
    ...
    assert lower_bound >= 469 and upper_bound <= 531
    ...
    # Now consider that the null hypothesis was the coin is not biased towards heads
